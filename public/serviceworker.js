...
toolbox.router.get(/\/users/, toolbox.networkFirst, {});
toolbox.router.get(/\/archive/, toolbox.networkFirst, {});
toolbox.router.get(/\/locationTime/, toolbox.networkFirst, {});
toolbox.router.get(/https:\/\/www\.gstatic\.com\/firebasejs\//, toolbox.networkFirst, {});
