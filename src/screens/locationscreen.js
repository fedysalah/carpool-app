                ...
                <div className="content">
                    <div className="card">
                        <ul className="table-view">
                            {locations.map(l => <li key={l} className="table-view-cell" onClick={this.select(l)}
                                                    style={{backgroundColor: this.state.location === l ? '#ECECEC' : 'white'}}>{l}</li>)}
                        </ul>
                    </div>
                    <div className="card">
                        <ul className="table-view">
                            ...
                            <li className="table-view-cell" style={{height: 60, paddingLeft: 10, paddingRight: 10}}>
                                <input type="time" onChange={this.changeDate} value={this.state.at}
                                       style={{width: '100%', height: 35, paddingLeft: 10, paddingRight: 10}}/>
                            </li>
                        </ul>
                    </div>
                </div>
